...
class SettingsPageState extends State<SettingsPage> {
  ...
  Widget buildSubtitle(String text) {
    return new Container(
      padding: const EdgeInsets.all(4.0),
      child: new Center(
        child: new Text(text, style: const TextStyle(color: Colors.black38)),
      ),
    );
  }
        ...
        body: new Container(
          ...
          child: new ListView(
            children: <Widget>[
              ...
              new ListTile(
                ...
                title: new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Text(SettingsConfig.favoriteDiningHall.description,
              ...
              new BooleanSettingWidget(
                  SettingsConfig.showVenueDescriptions, new Icon(Icons.edit)),
              new BooleanSettingWidget(SettingsConfig.collapseVenuesByDefault,
                  new Icon(Icons.remove_red_eye)),
              new BooleanSettingWidget(
                  SettingsConfig.showHallHours, new Icon(Icons.timer)),
              new BooleanSettingWidget(SettingsConfig.intelligentVenueOrdering,
                  new Icon(Icons.lightbulb_outline)),
              // DINING HALL SETTINGS END
              new Divider(color: Colors.black38),
              buildTitle('Dietary Preferences'),
              buildSubtitle(
                  'If any of these boxes are checked, only those types of foods will be shown.'),
              new BooleanSettingWidget(SettingsConfig.filterVeganFoods,
                  new Icon(Icons.restaurant_menu), true),
              new BooleanSettingWidget(SettingsConfig.filterVegetarianFoods,
                  new Icon(Icons.restaurant_menu), true),
              new BooleanSettingWidget(SettingsConfig.filterGlutenFreeFoods,
                  new Icon(Icons.restaurant_menu), true),
              new Divider(color: Colors.black38),
              ...
              new ListTile(
                ...
                subtitle: new Text(
                    'Something gone wrong? Tap here to return to the preloading page to reload data.'),
                onTap: () {
                  Navigator.of(context).pushReplacementNamed('/');
                },
              ),
              new BooleanSettingWidget(SettingsConfig.skipPreloadAutomatically,
